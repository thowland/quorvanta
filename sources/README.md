...
- **Data problems.** A count reported in the wrong unit, duplicate transmissions, a cancelled haemolysed specimen, and results from a lab whose certificate had lapsed.
